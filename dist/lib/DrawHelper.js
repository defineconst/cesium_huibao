...
//
    ...
    var defaultBillboard = {
        iconUrl: "source/images/dragIcon.png",
        shiftX: 0,
        shiftY: 0
    }
            ...
            if(position != null) {
                if(positions.length == 0) {
                    ...
                    if (cartesian) {
                        ...
                        // show tooltip
                        tooltip.showAt(position, "<p>添加一个新的坐标点 (" + positions.length + ")</p>" + (positions.length > minPoints ? "<p>双击完成绘制</p>" : ""));
                    }
                }
            }
        }, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.DrawHelperWidget = (function() {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: "source/images/glyphicons_242_google_maps.png",
                polylineIcon: "source/images/glyphicons_097_vector_path_line.png",
                polygonIcon:  "source/images/glyphicons_096_vector_path_polygon.png",
                circleIcon: "source/images/glyphicons_095_vector_path_circle.png",
                extentIcon: "source/images/glyphicons_094_vector_path_square.png",
                clearIcon: "source/images/glyphicons_067_cleaning.png",
