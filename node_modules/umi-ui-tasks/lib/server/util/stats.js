...
const getAvailablePort = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* () {
    _portfinder().default.basePort = 8888;
    _portfinder().default.highestPort = 9999;
    return yield _portfinder().default.getPortPromise();
  });
...
function parseChartData(stats) {
  ...
  if ((0, _lodash().isPlainObject)(chartData) && (0, _lodash().isEmpty)(chartData)) {
    chartData = null;
  }
