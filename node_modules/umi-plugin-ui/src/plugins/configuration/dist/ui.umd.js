(function (global, factory) {
	...
	(global = global || self, global.configuration = factory(global.window.React, global.window.antd));
	...
	*/
	...
	ControlFilled$1.displayName = 'ControlFilled';
	var ControlFilled$2 = React__default.forwardRef(ControlFilled$1);
	...
	var styles = {"normal":"index-module_normal__3msaf","configuration":"index-module_configuration__3ZvP-","configItem":"index-module_configItem__2PN50","basicConfig":"index-module_basicConfig__1kILS","group":"index-module_group__1tnVg"};
	styleInject(css);
	...
	var enUS = {
	  ...
	  'org.umi.ui.configuration.panel.description': 'Project Configuration',
	...
	var ui = (function (api) {
	  ...
	  api.addDashboard({
	    ...
	    // default enable
	    enable: false,
	    title: React__default.createElement(FormattedMessage, {
	      id: "org.umi.ui.configuration.panel"
	    }),
	    description: React__default.createElement(FormattedMessage, {
	      id: "org.umi.ui.configuration.panel.description"
	    }),
	    icon: React__default.createElement(ControlFilled$2, null),
	    content: [React__default.createElement("a", {
	      onClick: function onClick() {
	        return api.redirect('/configuration');
	      }
	    }, React__default.createElement(FormattedMessage, {
	      id: "org.umi.ui.configuration.project.config.title"
	    }))]
	  });
	  api.addPanel({
